...
namespace Bgg.Net.Common.Tests.RequestHandlers.Users
{
    ...
    public class UserHandlerTests : HandlerTestBase
    {
        ...
        public async Task GetUserByName_Success()
        {
            ...
            _handler = new UserHandler(_deserializerFactory.Object, Mock.Of<ILogger<RequestHandler>>(), _httpClientMock.Object, _validatorFactory.Object, _queryBuilder.Object);
